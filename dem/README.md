...
## 1. Request Parameters  
    ...
    Date Completed: 2024-11-28T18:26:46.644217  

    ID: 46630719-4521-41b7-bb22-3f9685508c14  

    Details:  

        Input Vector Name:            boulder_county
        ...
        Layers:  
                ...
                SRTMGL1_DEM (SRTMGL1_NC.003)  
      
        Output Projection:            Native Projection
        Output Format:                geotiff  

    Version: This request was processed by AppEEARS version 3.67  

## 2. Request File Listing  

**Supporting Files:**  

- Boulder-SRTM-SRTMGL1-NC-003-metadata.xml
- Boulder-SRTM-granule-list.txt
- Boulder-SRTM-request.json
...
Number of Extracted Data Files: 2  
Total Size of Extracted Data Files: 4.82 MB  
...
### 7.16. EMIT L2B Estimated Mineral Identification, Band Depth and Uncertainty
...
- NASA JPL (2013). NASA Shuttle Radar Topography Mission Global 1 arc second NetCDF. NASA EOSDIS Land Processes Distributed Active Archive Center. Accessed 2024-11-28 from https://doi.org/10.5067/MEaSUREs/SRTM/SRTMGL1_NC.003. Accessed November 28, 2024.

## 10. Software Citation  

AppEEARS Team. (2024). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 3.67. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed November 28, 2024. https://appeears.earthdatacloud.nasa.gov
